              ...
              {trips.map((trip, idx) => {
                ...
                return (
                  <tr key={trip.id || idx}>
                    ...
                    <td className="px-4 py-2 whitespace-nowrap">{originalRoute.name || 'N/A'}</td>
                    <td className="px-4 py-2 whitespace-nowrap">{trip.trips}</td>
                    <td className="px-4 py-2 whitespace-nowrap">${(originalRoute.driverPay || 0).toLocaleString()}</td>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">${((originalRoute.driverPay || 0) * (trip.trips || 1)).toLocaleString()}</td>
                  </tr>
                );
              })}
            </tbody>
